/**
 * @file Contains end-to-end tests for a deployed preview instance.
 */
...
describe("Fetch Cards", () => {
  ...
  test("retrieve stats card", async () => {
    ...
    // Check if the deployed stats card function is up and running.
    await expect(
    ...
    // Get the deployed stats card response.
  ...
  test("retrieve language card", async () => {
    ...
    // Check if the deployed language card function is up and running.
    console.log(
    ...
    // Get the deployed language card response.
  ...
  test("retrieve WakaTime card", async () => {
    ...
    // Check if the deployed WakaTime function is up and running.
    await expect(
    ...
    // Get the deployed WakaTime card response.
  ...
  test("retrieve repo card", async () => {
    ...
    // Check if the deployed repo function is up and running.
    await expect(
      axios.get(
    ...
    // Get the deployed repo card response.
  ...
  test("retrieve gist card", async () => {
    ...
    // Check if the deployed gist function is up and running.
    await expect(
      axios.get(
    ...
    // Get the deployed gist card response.
